...
function AdminProductPage () {
    ...
    return (
        <>
            <div className="container py-5">
                <div className="row">
                    ...
                    <div className="mb-3 d-flex">
                        <select name="sortPrice" id="" value={sortState} onChange={(e) => handleSortByPrice(e)}>
                            <option value="" disabled>-- 請選擇排序 --</option>
            ...
            <ProductModal isProductModalOpen={isProductModalOpen} setIsProductModalOpen={setIsProductModalOpen} modalState={modalState} tempProduct={tempProduct} getProducts={getProducts} pageInfo={pageInfo}/>
            <DeleteProductModal isDeleteProductModalOpen={isDeleteProductModalOpen} setIsDeleteProductModalOpen={setIsDeleteProductModalOpen} tempProduct={tempProduct} getProducts={getProducts} pageInfo={pageInfo}/>
        </>
    )
}
